...
export default function ScatterChart({ echartsDemoData, operation }: EchartsDemoData) {
    const scatterChart = useRef<HTMLDivElement>(null);//创建ref
    //初始化
    const initChartDom = () => {
        const myChart = echarts.init(scatterChart.current!);// 基于dom初始化echarts实例
